          ...
          <div class="col-sm-12">
            <section class="panel">
              ...
              <div class="panel-body minimal">
                <div class="col-md-4">
                  <h5 class="gen-case">
                     <a data-target="#modal_building" data-toggle="modal" class="MainNavText" id="MainNavHelp" href="#modal_building">Foto Single line ATS (masukkan 1 foto)</a> 
                  </h5>
                  <h5 class="gen-case">
                     <a data-target="#modal_building" data-toggle="modal" class="MainNavText" id="MainNavHelp" href="#modal_building">ATS</a> 
                  </h5>
                  <h5 class="gen-case">
                     <a data-target="#modal_building" data-toggle="modal" class="MainNavText" id="MainNavHelp" href="#modal_building">Inspeksi dan tes fungsi</a> 
                  </h5>
                  <h5 class="gen-case">
                    <a data-target="#modal_building" data-toggle="modal" class="MainNavText" id="MainNavHelp" href="#modal_building">Status Lampu Panel</a> 
                  </h5>
                  <h5 class="gen-case">
                     <a data-target="#modal_building" data-toggle="modal" class="MainNavText" id="MainNavHelp" href="#modal_building">Panel Kontrol Before</a> 
                  </h5>
                   <h5 class="gen-case">
                     <a data-target="#modal_building" data-toggle="modal" class="MainNavText" id="MainNavHelp" href="#modal_building">Panel Kontrol After</a> 
                  </h5>
                  <h5 class="gen-case">
