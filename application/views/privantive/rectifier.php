          ...
          <div class="col-sm-12">
            <section class="panel">
              ...
              <div class="panel-body minimal">
                <div class="col-md-4">
                  <h5 class="gen-case">
                     <a data-target="#modal_building" data-toggle="modal" class="MainNavText" id="MainNavHelp" href="#modal_building">Data Rectifier</a> 
                  </h5>
                  <h5 class="gen-case">
                  ...
                  <h5 class="gen-case">
                   ...
                   <h5 class="gen-case">
                     <a data-target="#modal_building" data-toggle="modal" class="MainNavText" id="MainNavHelp" href="#modal_building">Foto single line DCPDB (1 FOTO)</a> 
                  </h5>
                  <h5 class="gen-case">
