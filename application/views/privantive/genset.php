          ...
          <div class="col-sm-12">
            <section class="panel">
              ...
              <div class="panel-body minimal">
                <div class="col-md-4">
                  <h5 class="gen-case">
                     <a data-target="#modal_building" data-toggle="modal" class="MainNavText" id="MainNavHelp" href="#modal_building">Data FISIK</a> 
                  </h5>
                  <h5 class="gen-case">
                     <a data-target="#modal_building" data-toggle="modal" class="MainNavText" id="MainNavHelp" href="#modal_building">Inpeksi dan Tes Fungsi</a> 
                  </h5>
                  <h5 class="gen-case">
                     <a data-target="#modal_building" data-toggle="modal" class="MainNavText" id="MainNavHelp" href="#modal_building">Kondisi Beban Tol</a> 
                  </h5>
                  <h5 class="gen-case">
                    <a data-target="#modal_building" data-toggle="modal" class="MainNavText" id="MainNavHelp" href="#modal_building">Kondisi Beban Penuh</a> 
                  </h5>
                  <h5 class="gen-case">
